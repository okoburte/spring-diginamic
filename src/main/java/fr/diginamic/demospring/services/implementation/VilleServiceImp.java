...
public class VilleServiceImp implements VilleService {
    ...
    public VilleServiceImp(VilleRepository villeRepository, DepartementRepository departementRepository) {
    ...
    public ResponseEntity<?> extractVilles(Integer id, String nom, String codeDep, int min, Integer max) throws ExceptionElement {
        ...
        if(villes.isEmpty()) throw new ExceptionElement("Aucune ville dans la base de donnée correspond a :" + (nom != null ? " nom commencant par = " + nom + "." : "") + (codeDep != null ? " codeDep = " + codeDep + "." : "")
